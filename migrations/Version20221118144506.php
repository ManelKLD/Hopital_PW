 ...
 */
final class Version20221118144506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patients CHANGE Sexe Sexe VARCHAR(1) DEFAULT NULL, CHANGE Code_Motif Code_Motif INT DEFAULT NULL');
        $this->addSql('ALTER TABLE patients ADD CONSTRAINT FK_2CCC2E2CE51A4223 FOREIGN KEY (Code_Motif) REFERENCES motifs (Code)');
        $this->addSql('ALTER TABLE patients ADD CONSTRAINT FK_2CCC2E2C6CDE10B2 FOREIGN KEY (Sexe) REFERENCES sexe (Code)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patients CHANGE Code_Motif Code_Motif INT NOT NULL, CHANGE Sexe Sexe VARCHAR(1) NOT NULL');
